...
class IgnoringEqualiserCodeGenerator(fieldTypes: Array[LogicalType], fieldNames: Array[String], ignoredFields: Array[String]) {

  private val RECORD_EQUALISER = className[RecordEqualiser]
  private val LEFT_INPUT = "left"
  private val RIGHT_INPUT = "right"

  def this(rowType: RowType, fieldNames: Array[String], ignoredFields: Array[String]) = {
    this(rowType.getChildren.asScala.toArray, fieldNames, ignoredFields)
  }
