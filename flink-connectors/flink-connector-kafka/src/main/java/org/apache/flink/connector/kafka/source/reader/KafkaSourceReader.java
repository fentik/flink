...
public class KafkaSourceReader<T>
    ...
    // These maps need to be concurrent because it will be accessed by both the main
    // thread
    ...
    public List<KafkaPartitionSplit> snapshotState(long checkpointId) {
        ...
        if (splits.isEmpty() && offsetsOfFinishedSplits.isEmpty()) {
            ...
            Map<TopicPartition, OffsetAndMetadata> offsetsMap = offsetsToCommit.computeIfAbsent(checkpointId,
                    id -> new HashMap<>());
            ...
            for (KafkaPartitionSplit split : splits) {
                ...
                offsetsMap.put(
                        ...
                        new OffsetAndMetadata(split.getStartingOffset() >= 0 ? split.getStartingOffset() : 0L));
                // }
            }
