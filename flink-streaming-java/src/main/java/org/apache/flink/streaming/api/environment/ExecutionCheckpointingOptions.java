...
public class ExecutionCheckpointingOptions {
    public static final ConfigOption<CheckpointingMode> CHECKPOINTING_MODE = ConfigOptions
    ...
    public static final ConfigOption<Boolean> HOLD_BATCH_FOR_SAVEPOINT = ConfigOptions
            .key("execution.checkpointing.hold-batch-for-savepoint")
            .booleanType()
            .defaultValue(false)
            .withDescription("Prevent hybrid batch stream job from exiting on data complete and "
                    + "hold for a savepoint event, then exit");

    public static final ConfigOption<Duration> CHECKPOINTING_TIMEOUT = ConfigOptions
    ...
    public static final ConfigOption<Integer> MAX_CONCURRENT_CHECKPOINTS = ConfigOptions
    ...
    public static final ConfigOption<Duration> MIN_PAUSE_BETWEEN_CHECKPOINTS = ConfigOptions
    ...
    public static final ConfigOption<Integer> TOLERABLE_FAILURE_NUMBER = ConfigOptions
    ...
    public static final ConfigOption<CheckpointConfig.ExternalizedCheckpointCleanup> EXTERNALIZED_CHECKPOINT = ConfigOptions
    ...
    public static final ConfigOption<Duration> CHECKPOINTING_INTERVAL = ConfigOptions
    ...
    public static final ConfigOption<Boolean> ENABLE_UNALIGNED = ConfigOptions.key("execution.checkpointing.unaligned")
            .booleanType()
            .defaultValue(false)
            .withDescription(
                    Description.builder()
    ...
    public static final ConfigOption<Duration> ALIGNED_CHECKPOINT_TIMEOUT = ConfigOptions
            .key("execution.checkpointing.aligned-checkpoint-timeout")
            .durationType()
    ...
    @Deprecated
    public static final ConfigOption<Duration> ALIGNMENT_TIMEOUT = ConfigOptions
    ...
    public static final ConfigOption<Boolean> FORCE_UNALIGNED = ConfigOptions
    ...
    public static final ConfigOption<Long> CHECKPOINT_ID_OF_IGNORED_IN_FLIGHT_DATA = ConfigOptions
    ...
    public static final ConfigOption<Boolean> ENABLE_CHECKPOINTS_AFTER_TASKS_FINISH = ConfigOptions
            .key("execution.checkpointing.checkpoints-after-tasks-finish.enabled")
            .booleanType()
            .defaultValue(true)
            .withDescription(
                    Description.builder()
